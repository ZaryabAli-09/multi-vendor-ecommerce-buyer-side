  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/support&disputes/buyer/create`, // change to /seller to /buyer
        {
          method: "POST",
          headers: {
          ...
          credentials: "include",
          body: JSON.stringify({ subject, message, fromType: "Buyer" }), // change to Buyer
        }
      );
